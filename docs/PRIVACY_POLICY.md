...
| What is written to disk? | **Nothing** of yours. No local database. No `chrome.storage.local`. |
...
| `storage` | In-memory session only: share the live list across tabs. **Not** used to save data to disk or to us |
